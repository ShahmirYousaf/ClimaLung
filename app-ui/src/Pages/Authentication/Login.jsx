    ...
    <div className="auth-container">
      ...
      <div className="auth-form" ref={formRef}>
        ...
        <input className='password-input' name="password" type="password" placeholder="Password" />
          <button type="submit"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-lungs" viewBox="0 0 16 16">
        ...
        <div className="link-container">
          <p className='end-login-para'>Don't have an account? <Link className='signup-link' to="/signup"> Sign Up </Link></p>
